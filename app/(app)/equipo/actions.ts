...
export async function crearUsuario(data: UsuarioInput): Promise<Resultado> {
...
export async function actualizarUsuario(id: string, data: UsuarioInput): Promise<Resultado> {
  return ejecutar("actualizarUsuario", async () => {
...
export async function borrarUsuario(id: string): Promise<Resultado> {
  return ejecutar("borrarUsuario", async () => {
